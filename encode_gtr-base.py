...
def main():
    ...
    model = AutoModel.from_pretrained("sentence-transformers/gtr-t5-base").encoder.to("cuda")
    ...
    for (batch_ids, batch) in tqdm(encode_loader):
        ...
        with torch.cuda.amp.autocast() if training_args.fp16 else nullcontext():
            with torch.no_grad():
                ...
                embeddings = vec2text.models.model_utils.mean_pool(hidden_state, batch['attention_mask'])
