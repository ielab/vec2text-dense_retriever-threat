...
class EncoderModel(nn.Module):
    ...
    def __init__(self,
                 ...
                 pq_index: Optional[faiss.IndexPQ] = None,
                 noise: float = 0.0,
    ...
    def load(
        ...
        if os.path.exists(os.path.join(model_name_or_path, 'pq_index.faiss')):
            logger.info(f'found PQ index')
            pq_index = faiss.read_index(os.path.join(model_name_or_path, 'pq_index.faiss'))
        else:
            pq_index = None
