...
class BaseTrainer(transformers.Trainer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.metric_accuracy = evaluate.load("accuracy", experiment_id=self.args.experiment_id)
        self.metric_bleu = evaluate.load("sacrebleu", experiment_id=self.args.experiment_id)
        # self.metric_bertscore = evaluate.load("bertscore")
        self.metric_rouge = evaluate.load("rouge", experiment_id=self.args.experiment_id)
