...
CHECKPOINT_FOLDERS_DICT = {
    ...
    # "bert_msmarco__msl128__100epoch_ckpt300000": "/scratch/project/neural_ir/arvin/vec2text-reproduce/saves/bert-1/",
    # "gtr_base_st-embed__25epoch": "/scratch/project/neural_ir/arvin/vec2text-reproduce/saves/gtr_base_st-embed",
