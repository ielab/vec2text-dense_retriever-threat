...
class TrainingArguments(transformers.TrainingArguments):
    ...
    training_embedding_noise_level: float = field(
        default=0.0,
        metadata={
            "required": False,
            "help": "noise level for training inversion and corrector. default is 0.0"
        }
    )
    ...
    experiment_id: str = field(
        ...
        metadata={
            "required": False,
            "help": "ID to identify this specific run of an experiment",
        },
    )
    ...
    pq_quantization_m: int = field(
        default=0,
        metadata={"help": "Number of sub-vectors for PQ quantization to embedder, 0 means do not do PQ quantization"},
    )

    str_mix_augmentation: bool = field(
        default=False,
        metadata={
            "help": "Will double the batch size and use_frozen_embeddings_as_input has to be False."
        },
    )
